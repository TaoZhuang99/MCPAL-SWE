...
% =========================================================================
function [prs, vel] = CircPal_SWE_Addition_new_0328(pal1, pal2, fp, nuMax, T1, T2, Gaunt_coeff, br, varargin)
...
for ir = 1:length(fp.r)
    ...
    if fp.r(ir) < br
        ...
        R_temp = CircPal_SWE_Addition_Radial_int_dim(pal_radius, br, la, wn2, fp.r(ir), nu1, nu2);
        ...
        R_temp = CircPal_SWE_Addition_Radial_ext_new_0217(pal_radius, br, la, wn2, fp.r(ir), nu1, nu2);
        coeff_rad1 = Tcoeff.int;
    ...
    for itheta = 1:length(fp.theta)
        ...
        Y = SphHarmonic_ext_new(la, mu1, mu2, fp.theta(itheta), fp.phi(iphi));
