...
% =========================================================================
function [prs, vel] = CircPal_SWE_Addition_new_0410A(pal1, pal2, fp, Y_tot, sum_coef, T1, T2, Gaunt_coeff, br, varargin)
    ...
    R = 0 * vec2ndim(fp.r, 6) .* sum_coef.la .* sum_coef.nu1 .* sum_coef.nu2 .*...
        sum_coef.mu1 .* sum_coef.mu2;
...
prs = 16 * pi^2 * 1.2 * p0^2 / (1i*1.21*343^2) * ... 
    sum((-1).^sum_coef.mu2 .* Gaunt_coeff .* R .* Y_tot, [1 2 3 4 5]);
